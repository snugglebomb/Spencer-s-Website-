      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Cybersecurity */}
            <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-6 hover:border-red-400/30 transition-all duration-300">
            ...
            {/* Operating Systems */}
            <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-6 hover:border-blue-400/30 transition-all duration-300">
            ...
            {/* Network Management */}
            <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-6 hover:border-green-400/30 transition-all duration-300">
            ...
            <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-6 hover:border-purple-400/30 transition-all duration-300">
              <div className="w-12 h-12 bg-purple-600 rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">Computer Work</h3>
              <ul className="text-gray-300 space-y-1 text-sm">
            ...
            {/* Telecommunications */}
            <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-6 hover:border-yellow-400/30 transition-all duration-300">
            ...
            <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-6 hover:border-cyan-400/30 transition-all duration-300">
              <div className="w-12 h-12 bg-cyan-600 rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">Financial Skills</h3>
              <ul className="text-gray-300 space-y-1 text-sm">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-6 text-center">
            ...
            <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-6 text-center">
              <div className="text-4xl mb-3">💰</div>
              <h3 className="text-lg font-semibold text-white mb-2">Cashiering</h3>
              <p className="text-gray-400 text-sm">
            ...
            <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-6 text-center">
              <div className="text-4xl mb-3">👥</div>
              <h3 className="text-lg font-semibold text-white mb-2">Managing</h3>
              <p className="text-gray-400 text-sm">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 border border-yellow-400/30 rounded-xl p-6">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">CompTIA CySA+</h3>
        ...
        <div className="bg-neutral-900/50 backdrop-blur border border-white/10 rounded-xl p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <span className="text-white font-medium">Network Management</span>
                <span className="text-gray-400 text-sm">Advanced</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2">
                <div className="bg-gradient-to-r from-green-500 to-blue-500 h-2 rounded-full w-5/6"></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-700 rounded-full h-2">
                <div className="bg-gradient-to-r from-yellow-500 to-red-500 h-2 rounded-full w-11/12"></div>
              </div>
            </div>
            
            <div>
              <div className="flex justify-between items-center mb-2">
                <span className="text-white font-medium">Linux/Windows Systems</span>
                <span className="text-gray-400 text-sm">Advanced</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <span className="text-white font-medium">Financial Management</span>
                <span className="text-gray-400 text-sm">Intermediate</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2">
