  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          {accountOpen && (
            <div className="absolute right-0 mt-2 bg-green-100 shadow-md rounded p-4 w-40 text-left" onClick={(e) => e.stopPropagation()}>
              <button className="w-full text-green-700 hover:text-green-800">Sign In</button>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center">
        <h1 className="text-4xl font-bold text-green-500 mb-4">🎓 Welcome to GMUnderground</h1>
        <p className="text-center text-green-700 mb-8 max-w-xl">
          A student-powered hub for events, services, items for sale, and everything happening beneath the surface at GMU.
        </p>
        <div className="space-y-4 w-full max-w-sm">
          <Link href="/feed" className="block text-center bg-green-700 text-white py-2 rounded hover:bg-green-800 transform transition hover:scale-105">
            📰 View Feed
          </Link>
          <Link href="/events" className="block text-center bg-green-700 text-white py-2 rounded hover:bg-green-800 transform transition hover:scale-105">
            📅 View Events
          </Link>
          <Link href="/marketplace" className="block text-center bg-green-700 text-white py-2 rounded hover:bg-green-800 transform transition hover:scale-105">
            💰 Visit Marketplace
          </Link>
        </div>
      </div>
      ...
      <div className="mt-12 overflow-hidden whitespace-nowrap border-t border-b py-4">
        <div className="animate-marquee inline-block min-w-full">
          <div className="inline-block mx-4 px-4 py-2 bg-white border border-gray-300 rounded shadow-sm text-green-700">
      ...
      <div className="mt-16 flex justify-center items-center">
        <div className="bg-white bg-opacity-80 border border-gray-300 rounded-lg shadow-lg p-6 max-w-sm w-full text-center">
          <h2 className="text-2xl font-semibold text-green-700 mb-4">Join GMUnderground</h2>
          <p className="text-green-700 mb-6">Sign in or create an account to start posting and interacting.</p>
          <div className="flex flex-col gap-4">
            <button className="bg-green-700 text-white py-2 rounded hover:bg-green-800 transform transition hover:scale-105">
              Sign Up
            </button>
            <button className="bg-green-700 text-white py-2 rounded hover:bg-green-800 transform transition hover:scale-105">
              Sign In
      ...
      {/* Footer */}
      <footer className="mt-12 text-green-700 text-sm">
